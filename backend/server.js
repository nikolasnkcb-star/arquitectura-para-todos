...
- Adapta tus respuestas según lo que el usuario diga.
...
Debes responder SIEMPRE con un objeto JSON válido con la siguiente estructura:
{
  ...
  "extractedData": { "location": "...", "dimensions": "...", "slope": "...", "floors": "...", "people": "...", "rooms": "...", "budget": "...", "style": "..." },
  "progress": 25, // Un número del 0 al 100
  "finished": false // true SOLO cuando tengas los 8 datos.
}

Datos actuales recopilados: ${JSON.stringify(projectData)}
Historial de conversación: ${JSON.stringify(history.slice(-6))}
`;
